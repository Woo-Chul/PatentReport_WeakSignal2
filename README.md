# <img src="/img/kipi_logo.png" width="5%" height="3%" title="px(픽셀) 크기 설정" alt="kipi" align="left">KIPI DATA INSIGHT 제2호 : 특허 DATA의 CPC를 활용한 미래 기술 위크시그널 분석</img>

# Preview

- **제목** :  특허 DATA의 CPC를 활용한 미래 기술 위크시그널 분석
